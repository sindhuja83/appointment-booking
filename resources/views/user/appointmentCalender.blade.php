...
<body>
        ...
        <p><h2  style="margin-left:300px"><b>Patient's Appointments - Calendar</b></h2></p><br><br>
        <div class="panel panel-primary">
        <div class="panel-heading">
        <h3><b>Hello ! {{auth('web')->user()->user_name}}
        <a href="{{ route('homepage') }}" class="btn btn-lg btn-warning" style="margin-left:800px">Back</a>
        </b></h3>
        </div>
